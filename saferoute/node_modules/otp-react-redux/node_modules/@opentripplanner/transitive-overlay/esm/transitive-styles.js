...
STYLES.places = {
  display: function display(_display, place) {
    return coreUtils.map.isBikeshareStation(place) || coreUtils.map.isEScooterStation(place) || coreUtils.map.isCarWalkTransition(place) ? true : "none";
  },
  fill: function fill(display, place) {
...
//# sourceMappingURL=transitive-styles.js.map