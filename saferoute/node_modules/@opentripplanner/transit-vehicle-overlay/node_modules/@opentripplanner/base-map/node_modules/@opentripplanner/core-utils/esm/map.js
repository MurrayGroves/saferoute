...
import { getPlaceName, isTransit, isFlex, toSentenceCase, isAccessMode } from "./itinerary";
  ...
  itin.legs.forEach(function (leg, idx) {
    if (isAccessMode(leg.mode)) {
      ...
      if (leg.from.bikeShareId) {
        fromPlaceId = "bicycle_rent_station_".concat(leg.from.bikeShareId); // TODO: does this need to change to be OTP2 compatible?
