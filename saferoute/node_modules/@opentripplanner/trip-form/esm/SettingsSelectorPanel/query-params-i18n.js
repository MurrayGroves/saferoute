...
import { FormattedMessage } from "react-intl"; // eslint-disable-next-line prettier/prettier
...
function getDurationOptions(intl, minuteOptions) {
  ...
  return minuteOptions.map(function (minutes) {
    return {
...
function getDistanceOptionsInMiles(intl, mileOptions) {
  // intl is needed because <FormattedMessage> can't be used inside <option>.
  return mileOptions.map(function (miles) {
    return {
      text: intl.formatMessage({
        defaultMessage: "".concat(miles, " miles"),
...
function getSpeedOptionsInMilesPerHour(intl, milesPerHourOptions) {
  // intl is needed because <FormattedMessage> can't be used inside <option>.
  return milesPerHourOptions.map(function (mph) {
    return {
      text: intl.formatMessage({
        defaultMessage: "".concat(mph, " mph"),
...
export function getQueryParamMessagesWithI18n(intl) {
  return {
    maxWalkDistance: {
    ...
    walkReluctance: {
      ...
      labelLow: /*#__PURE__*/React.createElement(FormattedMessage, {
      ...
      labelHigh: /*#__PURE__*/React.createElement(FormattedMessage, {
    ...
    optimizeBike: {
      ...
      options: function options() {
        return getBikeTripOptions(intl);
      }
    },
    maxWalkTime: {
      label: /*#__PURE__*/React.createElement(FormattedMessage, {
