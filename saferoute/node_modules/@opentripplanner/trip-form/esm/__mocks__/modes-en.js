...
var commonModes = {
  ...
  categories: [{
    ...
    label: "+ Bike or Bike".concat("\xA0", "Rental"),
    type: "access",
    options: [{
      mode: "BICYCLE",
      label: "Personal Bike"
    ...
    description: "E-scooters are battery-powered devices that you can rent on-the-spot using an app on your phone. You can quickly and easily connect to and from your transit stop, using one of several scooter brands operating in the Portland area.",
    id: "SCOOTER",
    image: scooterImage,
  ...
  accessModes: [{
    ...
    mode: "BICYCLE_RENT",
    label: "Transit + Biketown" // No company required here.
...
//# sourceMappingURL=modes-en.js.map