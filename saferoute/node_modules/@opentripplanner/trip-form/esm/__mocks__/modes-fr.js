...
var commonModes = {
  ...
  categories: [{
    ...
    label: "V\xE9lo ou v\xE9lo".concat("\xA0", "partag\xE9"),
    type: "access",
    options: [{
      mode: "BICYCLE",
    ...
    label: "Course en voiture ou Parc".concat("\xA0", "relais"),
    type: "access",
    options: [{
      mode: "CAR_PARK",
      label: "Parc relais"
  ...
  accessModes: [{
    ...
    mode: "BICYCLE_RENT",
    label: "Transports + Biketown" // No company required here.
...
//# sourceMappingURL=modes-fr.js.map